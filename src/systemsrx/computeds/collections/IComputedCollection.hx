package systemsrx.computeds.collections; #if (concurrent || sys) import rx.Observable; #end import systemsrx.computeds.IComputed; /** * Interface for a computed collection of elements. * @typeparam T The type of elements in the collection. */ 
