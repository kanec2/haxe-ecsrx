...
/** 
 * Interface for tracking an individual entity's observable group matching changes. 
 * Extends IObservableGroupTracker to provide a way to check if the entity is currently matching the group. 
 */
interface IIndividualObservableGroupTracker extends IObservableGroupTracker {
	/** 
	 * Checks if the entity is currently matching the group. 
